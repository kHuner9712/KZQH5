/**
 * Product Asset unpublish API (Section 4).
 *   POST /api/admin/product-assets/[id]/unpublish
 *
 * Atomically transitions a published asset back to draft:
 *   - is_published=false, publish_status='draft'
 *   - clears published_bucket / published_object_path
 *   - enqueues old public object for cleanup
...
import { unpublishProductAsset } from "@/lib/services/admin-product-asset-write";
...
export async function POST(
  ...
  const result = await unpublishProductAsset(
    guard.client,
