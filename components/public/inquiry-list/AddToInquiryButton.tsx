...
export function AddToInquiryButton({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex min-h-10 items-center justify-center gap-1.5 rounded-md border border-gold/40 px-3 text-xs font-medium text-gold-dark transition hover:border-gold",
        compact && "min-h-11 px-2 text-[11px] md:min-h-9",
        className,
      )}
